...
export const siteHomeSettings = sqliteTable("site_home_settings", {
  ...
  heroImageUrl: text("hero_image_url").notNull().default("/community-hero-group.jpg"),
  heroImageAlt: text("hero_image_alt").notNull().default("Community members gathering together"),
...
export const homeSettingsSchemaSql = `CREATE TABLE IF NOT EXISTS site_home_settings (
  ...
  title TEXT NOT NULL,
  intro TEXT NOT NULL,
  hero_image_url TEXT NOT NULL DEFAULT '/community-hero-group.jpg',
  hero_image_alt TEXT NOT NULL DEFAULT 'Community members gathering together',
